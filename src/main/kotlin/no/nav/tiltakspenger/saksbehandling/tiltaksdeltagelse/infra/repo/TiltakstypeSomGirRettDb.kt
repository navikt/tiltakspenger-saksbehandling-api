...
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.ARBEIDSFORBEREDENDE_TRENING
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.ARBEIDSRETTET_REHABILITERING
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.ARBEIDSTRENING
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.AVKLARING
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.DIGITAL_JOBBKLUBB
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.ENKELTPLASS_AMO
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.ENKELTPLASS_VGS_OG_HØYERE_YRKESFAG
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.FORSØK_OPPLÆRING_LENGRE_VARIGHET
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.GRUPPE_AMO
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.GRUPPE_VGS_OG_HØYERE_YRKESFAG
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.HØYERE_UTDANNING
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.INDIVIDUELL_JOBBSTØTTE
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.INDIVIDUELL_KARRIERESTØTTE_UNG
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.JOBBKLUBB
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.OPPFØLGING
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.UTVIDET_OPPFØLGING_I_NAV
import no.nav.tiltakspenger.saksbehandling.tiltaksdeltagelse.infra.repo.TiltakstypeSomGirRettDb.UTVIDET_OPPFØLGING_I_OPPLÆRING
