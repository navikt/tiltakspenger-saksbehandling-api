...
data class Klagebehandling(
    ...
    val resultat: KlagebehandlingResultat?,
    ...
    companion object {
        fun create(
            ...
            return Klagebehandling(
                ...
                resultat = if (formkrav.erAvvisning) KlagebehandlingResultat.AVVIST else null,
            )
        }
    }
    ...
    init {
        if (formkrav.erAvvisning) {
            require(resultat == KlagebehandlingResultat.AVVIST) {
