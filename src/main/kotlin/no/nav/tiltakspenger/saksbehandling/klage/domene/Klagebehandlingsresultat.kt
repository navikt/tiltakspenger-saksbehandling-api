...
sealed interface Klagebehandlingsresultat {
    ...
    val behandlingId: List<BehandlingId>
    ...
    data class Avvist(override val brevtekst: Brevtekster?) : Klagebehandlingsresultat {
        ...
        override val behandlingId: List<BehandlingId> = emptyList()
    ...
    data class Omgjør(
        ...
        override val behandlingId: List<BehandlingId>,
        ...
        override val harJournalførtInnstillingsbrev = false
        override val harDistribuertInnstillingsbrev = false
        override val erKnyttetTilBehandling = behandlingId.isNotEmpty()
        ...
        override fun leggTilNyÅpenBehandling(
            ...
            return this.copy(
                behandlingId = this.behandlingId.plus(behandlingId),
