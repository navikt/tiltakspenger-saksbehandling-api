...
sealed interface Klagebehandlingsresultat {
    ...
    data class Opprettholdt(
        ...
        val klageinsttansehendelser: Klageinstanshendelser,
    ) : Klagebehandlingsresultat {
        ...
        fun leggTilKlageinstanshendelse(hendelse: Klageinstanshendelse): Opprettholdt {
            return copy(klageinsttansehendelser = klageinsttansehendelser.leggTil(hendelse))
        }
        ...
        companion object {
            fun create(hjemler: Klagehjemler): Opprettholdt {
                return Opprettholdt(
                    ...
                    klageinsttansehendelser = Klageinstanshendelser.empty(),
                )
            }
        }
