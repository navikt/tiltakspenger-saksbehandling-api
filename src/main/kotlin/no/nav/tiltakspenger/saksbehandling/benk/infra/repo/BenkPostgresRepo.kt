 ...
 */
private fun <K : BenkSorteringKolonne> BenkSortering<K>.tilOrderBy(kolonneTilDb: (K) -> String): String =
...
private fun Row.tilFelles(): BenkBehandlingsfelles = BenkBehandlingsfelles(
...
private fun Row.tilBehandlingsstatus(): BenkBehandlingsstatus =
    enum("status", BenkBehandlingsstatus.entries)
