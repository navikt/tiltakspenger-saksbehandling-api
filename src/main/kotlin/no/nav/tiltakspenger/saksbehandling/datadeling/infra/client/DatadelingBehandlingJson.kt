...
fun Søknadsbehandling.toBehandlingJson(): String {
    return DatadelingBehandlingDTO(
        ...
        fraOgMed = virkningsperiode?.fraOgMed ?: saksopplysninger.tiltaksdeltagelse.tidligsteFraOgMed
            ?: søknad.tiltak.deltakelseFom,
        tilOgMed = virkningsperiode?.tilOgMed ?: saksopplysninger.tiltaksdeltagelse.senesteTilOgMed
