package no.nav.tiltakspenger.saksbehandling.barnetillegg.infra.route
...
import no.nav.tiltakspenger.saksbehandling.behandling.domene.behandling.OppdaterBarnetilleggKommando
...
): no.nav.tiltakspenger.saksbehandling.behandling.domene.behandling.OppdaterBarnetilleggKommando =
    no.nav.tiltakspenger.saksbehandling.behandling.domene.behandling.OppdaterBarnetilleggKommando(
        sakId = sakId,
        behandlingId = behandlingId,
        correlationId = correlationId,
...
fun Route.oppdaterBarnetilleggRoute(
    ...
    oppdaterBarnetilleggService: no.nav.tiltakspenger.saksbehandling.behandling.service.behandling.OppdaterBarnetilleggService,
) {
