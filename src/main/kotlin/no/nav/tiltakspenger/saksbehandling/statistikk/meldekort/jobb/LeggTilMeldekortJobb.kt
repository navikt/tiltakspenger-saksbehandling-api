...
class LeggTilMeldekortJobb(
    ...
    fun leggTilManglendeMeldekortStatistikk() {
        ...
        val godkjenteKorrigerteMeldekortbehandlinger = meldekortBehandlingRepo.hentGodkjenteKorrigerteBehandlinger()
        ...
        godkjenteKorrigerteMeldekortbehandlinger.forEach { korrigertBehandling ->
            ...
            val meldekortbehandlinger = meldekortBehandlingRepo.hentForSakId(korrigertBehandling.sakId)
            ...
            andreGodkjenteMeldekortbehandlingerSammeKjede.forEach {
                ...
                if (!finnesIMeldekortStatisikk(it.id)) {
    ...
    private fun finnesIMeldekortStatisikk(meldekortId: MeldekortId): Boolean {
