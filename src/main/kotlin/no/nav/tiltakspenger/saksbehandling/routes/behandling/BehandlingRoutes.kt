...
import no.nav.tiltakspenger.saksbehandling.routes.behandling.barnetillegg.oppdaterBarnetilleggRoute
import no.nav.tiltakspenger.saksbehandling.routes.behandling.beslutter.iverksettBehandlingRoute
import no.nav.tiltakspenger.saksbehandling.routes.behandling.brev.forhåndsvisVedtaksbrevRoute
import no.nav.tiltakspenger.saksbehandling.routes.behandling.brev.oppdaterFritekstTilVedtaksbrevRoute
import no.nav.tiltakspenger.saksbehandling.routes.behandling.personopplysninger.hentPersonRoute
