 ...
 */
sealed interface MeldekortBeregningOld : List<MeldeperiodeBeregningDag> {
    val periode: Periode
    val sakId: SakId
...
private fun MeldekortBeregningOld.validerAntallDager(): Either<KanIkkeSendeMeldekortTilBeslutning.ForMangeDagerUtfylt, Unit> {
