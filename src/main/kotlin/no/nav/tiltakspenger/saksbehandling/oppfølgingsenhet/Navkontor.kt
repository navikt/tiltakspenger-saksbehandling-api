...
data class Navkontor(
    ...
    /**
     * Navkontor er stedslokaliserende persondata og skal ikke havne i vanlig logg. Vi overstyrer derfor
     * [toString] slik at verken [kontornummer] eller [kontornavn] eksponeres dersom et [Navkontor]-objekt
     * ved et uhell blir logget (f.eks. via en data class som inneholder det). Trenger man de faktiske
     * verdiene må man hente dem eksplisitt og logge til sikkerlogg.
     */
    override fun toString(): String = "Navkontor(********)"

    /**
     * Full representasjon med de faktiske verdiene. Skal KUN brukes når vi logger til sikkerlogg
     * (eller annet sted hvor det er lov å eksponere stedslokaliserende persondata) - aldri i vanlig logg.
     */
