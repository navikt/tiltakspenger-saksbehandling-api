...
class HentSaksopplysingerService(
    ...
    suspend fun hentSaksopplysningerFraRegistre(
        ...
        // Utbetaldata støtter seneste dato i dag.
        ...
        val utbetaldataPeriode =
            if (utbetaldataFraOgMed == null || utbetaldataTilOgMed == null || utbetaldataTilOgMed < utbetaldataFraOgMed) {
                null
            } else {
                saksopplysningsperiode.copy(
                    fraOgMed = utbetaldataFraOgMed,
                    tilOgMed = utbetaldataTilOgMed,
                )
            }
