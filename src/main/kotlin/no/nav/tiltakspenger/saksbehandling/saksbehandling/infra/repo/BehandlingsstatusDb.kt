...
import no.nav.tiltakspenger.saksbehandling.saksbehandling.infra.repo.BehandlingsstatusDb.KLAR_TIL_BEHANDLING
import no.nav.tiltakspenger.saksbehandling.saksbehandling.infra.repo.BehandlingsstatusDb.KLAR_TIL_BESLUTNING
import no.nav.tiltakspenger.saksbehandling.saksbehandling.infra.repo.BehandlingsstatusDb.UNDER_BEHANDLING
import no.nav.tiltakspenger.saksbehandling.saksbehandling.infra.repo.BehandlingsstatusDb.UNDER_BESLUTNING
import no.nav.tiltakspenger.saksbehandling.saksbehandling.infra.repo.BehandlingsstatusDb.VEDTATT
