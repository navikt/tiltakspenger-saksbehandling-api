...
object MetricRegister {
    ...
    val STARTET_BEHANDLING_PAPIRSØKNAD: Counter = Counter.builder()
        .name("${METRICS_NS}_startet_behandling_papirsoknad_count")
        .help("Antall startede behandlinger av papirsøknader")
        .withoutExemplars()
        .register()
