...
fun Route.routes(
    ...
    authenticate(IdentityProvider.AZUREAD.value) {
        ...
        klagebehandlingRoutes(
            ...
            ferdigstillKlagebehandlingService = applicationContext.klagebehandlingContext.ferdigstillKlagebehandlingService,
            visInnstillingsbrevKlagebehandlingService = applicationContext.klagebehandlingContext.visInnstillingsbrevKlagebehandlingService,
            clock = applicationContext.clock,
        )
        hentBenkRoute(
        ...
        meldekortRoutes(
            iverksettMeldekortbehandlingService = applicationContext.meldekortContext.iverksettMeldekortbehandlingService,
            oppdaterMeldekortbehandlingService = applicationContext.meldekortContext.oppdaterMeldekortbehandlingService,
            ...
            sendMeldekortbehandlingTilBeslutterService = applicationContext.meldekortContext.sendMeldekortbehandlingTilBeslutterService,
