...
class OppsummeringGeneratorTest {
    ...
    fun `feilutbetaling `() {
         ...
         *
         * Meldeperiode:
         * 28.10.2024 - 10-11-2024 (endret fra 100% til 100% -> ingen endring) Påvirker også meldeperiodene:
         * 11.11.2024 - 24.11.2024 2211 -> 2140 (71 kroner/100->75% av 285) 25.11.2024 - 08.12.2024 2281 -> 2067 (214 kroner/75%->0% av 285)
         *
         * Dette er en buggy simulering/utbetaling pga. bug ved bruk av kode 7.
         * Fra dev.
         * Deltatt 10 ukedager i første vedtak.
         * Korrigerer 2. og 3. desember til deltatt med lønn (fra 100% ->0%) Forventer minus 570 (2*285) kroner til feilkonto.
         *
