 ...
 */
interface LeggKlagebehandlingTilbakeBuilder {
     ...
     */
    suspend fun ApplicationTestBuilder.iverksettSøknadsbehandlingOgLeggKlagebehandlingTilbake(
    ...
    suspend fun ApplicationTestBuilder.leggKlagebehandlingTilbake(
        tac: TestApplicationContext,
        sakId: SakId,
        ...
        defaultRequest(
            ...
            url {
                ...
                path("/sak/$sakId/klage/$klagebehandlingId/legg-tilbake")
            },
            jwt = jwt,
        ).apply {
            ...
            val klagebehandlingId =
                KlagebehandlingId.fromString(jsonObject.get("klageBehandlinger").first().get("id").asText())
