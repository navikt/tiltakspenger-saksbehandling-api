...
import no.nav.tiltakspenger.saksbehandling.infra.route.shouldBeEqualToIgnoringFieldsOfTypeRecursively
...
class GjenopptaKlagebehandlingMedRammebehandlingRouteTest {
    ...
    fun `kan gjenoppta klagebehandling med rammebehandling`() {
        ...
        withTestApplicationContextAndPostgres(clock = clock, runIsolated = true) { tac ->
            ...
            klagebehandling.ventestatus.shouldBeEqualToIgnoringFieldsOfTypeRecursively(
                Ventestatus(
                    listOf(
                        VentestatusHendelse(
            ...
            rammebehandlingMedKlagebehandling.ventestatus.shouldBeEqualToIgnoringFieldsOfTypeRecursively(
                Ventestatus(
                    listOf(
                        VentestatusHendelse(
