...
interface SettKlagebehandlingPåVentBuilder {
    ...
    suspend fun ApplicationTestBuilder.iverksettSøknadsbehandlingOgSettKlagebehandlingPåVent(
        ...
        val (oppdatertSak, oppdatertKlagebehandling, json) = settKlagebehandlingPåVent(
            tac = tac,
            sakId = sak.id,
    ...
    suspend fun ApplicationTestBuilder.settKlagebehandlingPåVent(
        tac: TestApplicationContext,
        sakId: SakId,
        ...
        defaultRequest(
            ...
            url {
                ...
                path("/sak/$sakId/klage/$klagebehandlingId/vent")
            },
            jwt = jwt,
        ) {
            setBody(
