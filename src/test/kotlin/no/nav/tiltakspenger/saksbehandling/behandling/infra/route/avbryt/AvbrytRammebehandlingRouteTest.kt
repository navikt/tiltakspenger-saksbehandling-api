    ...
    fun `oppretter søknadsbehandling og deretter avbryter`() {
        withTestApplicationContext { tac ->
            ...
            json.get("rammebehandlinger").single().toString().shouldBeSøknadsbehandlingDTO(
                ...
                søknadHendelserJson = """[{"type": "AVBRUTT","tidspunkt": "2025-05-01T01:02:13.456789","utførtAv": "Z12345","begrunnelse": "begrunnelse for avbryt søknad og/eller rammebehandling"}]""",
                gyldigeKommandoer = listOf("Gjenopprett"),
            )
        }
    }
