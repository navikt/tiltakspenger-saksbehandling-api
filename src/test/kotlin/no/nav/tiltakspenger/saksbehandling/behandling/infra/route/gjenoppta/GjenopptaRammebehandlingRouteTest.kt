    ...
    fun `gjenoppta søknadsbehandling`() {
        withTestApplicationContext { tac ->
            ...
            json.rammebehandlingJson(søknadsbehandling!!.id).toString().shouldBeSøknadsbehandlingDTO(
                ...
                //language=json
                ventestatus = listOf(
                    """{"sattPåVentAv": "Z12345","status": "KLAR_TIL_BEHANDLING","tidspunkt": "2025-05-01T01:02:16.456789","begrunnelse": {"verdi": "", "erSladdet": false},"erSattPåVent": false,"frist": null}""",
                    """{"sattPåVentAv": "Z12345", "status": "UNDER_BEHANDLING","tidspunkt": "2025-05-01T01:02:17.456789","begrunnelse": {"verdi": "Begrunnelse for å sette rammebehandling på vent", "erSladdet": false},"erSattPåVent": true,"frist": null}""",
                ),
