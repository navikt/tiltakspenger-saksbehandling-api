...
class OppdaterBehandlingRouteTest {
    ...
    @Test
    @Disabled("Enables etter vi har fikset beregningen for omgjøring")
    fun `revurdering til omgjøring - kan oppdatere behandlingen etter saksopplysninger har endret seg`() {
        withTestApplicationContext { tac ->
            ...
            resultat.antallDagerPerMeldeperiode shouldBe antallDagerPerMeldeperiodeForPerioder
            resultat.valgteTiltaksdeltakelser shouldBe valgteTiltaksdeltakelser
