...
/**
 * Route: [no.nav.tiltakspenger.saksbehandling.behandling.infra.route.angreRammebehandlingRoute]
 */
interface AngreRammebehandlingBuilder {

    /**
     * Forventer at det finnes en behandling med status `KLAR_TIL_BESLUTNING`.
     * Returnerer null dersom responsen ikke er 200 OK.
     */
    suspend fun ApplicationTestBuilder.angreRammebehandling(
