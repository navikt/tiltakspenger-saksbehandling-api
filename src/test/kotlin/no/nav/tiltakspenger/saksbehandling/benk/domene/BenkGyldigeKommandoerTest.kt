 ...
 * Reglene speiler domenets `finnGyldigeKommandoer`-funksjoner, og er i tillegg pinnet mot dem gjennom prodstien i `BenkAggregatTest`.
 */
class BenkGyldigeKommandoerTest {
    ...
    private fun felles(
        ...
        beslutter = beslutter,
        erUnderkjent = false,
        ventestatus = BenkVentestatus(erSattPåVent = erSattPåVent, begrunnelse = null, frist = null),
    )
    ...
    inner class Rammebehandlinger {
        ...
        fun `klar til behandling kan tildeles og avbrytes`() {
            søknadsbehandling(BenkBehandlingsstatus.KLAR_TIL_BEHANDLING, felles())
        ...
        fun `under automatisk behandling kan settes på vent og avbrytes`() {
            søknadsbehandling(BenkBehandlingsstatus.UNDER_AUTOMATISK_BEHANDLING, felles())
    ...
    inner class Meldekort {
        ...
        fun `klar til behandling kan tildeles, men ikke avbrytes`() {
            meldekort(BenkBehandlingsstatus.KLAR_TIL_BEHANDLING, felles())
