...
internal class SøknadDTOMapperTest {
    val internTiltaksdeltakerId = UUID.randomUUID().toString()
    ...
    fun `ja i alt`() {
        ...
        assertEquals(søknad.intro, Søknad.PeriodeSpm.Ja(fraOgMed = fra, tilOgMed = til))
        assertEquals(søknad.institusjon, Søknad.PeriodeSpm.Ja(fraOgMed = fra, tilOgMed = til))
        assertEquals(søknad.jobbsjansen, Søknad.PeriodeSpm.Ja(fraOgMed = fra, tilOgMed = til))
        assertEquals(søknad.supplerendeStønadAlder, Søknad.PeriodeSpm.Ja(fraOgMed = fra, tilOgMed = til))
        assertEquals(søknad.supplerendeStønadFlyktning, Søknad.PeriodeSpm.Ja(fraOgMed = fra, tilOgMed = til))
        assertEquals(søknad.sykepenger, Søknad.PeriodeSpm.Ja(fraOgMed = fra, tilOgMed = til))
        assertEquals(søknad.alderspensjon, Søknad.FraOgMedDatoSpm.Ja(fra = fra))
        assertEquals(søknad.gjenlevendepensjon, Søknad.PeriodeSpm.Ja(fraOgMed = fra, tilOgMed = til))
        assertEquals(søknad.trygdOgPensjon, Søknad.PeriodeSpm.Ja(fraOgMed = fra, tilOgMed = til))
