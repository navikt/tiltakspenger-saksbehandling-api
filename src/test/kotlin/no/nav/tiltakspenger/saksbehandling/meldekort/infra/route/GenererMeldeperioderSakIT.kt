...
class GenererMeldeperioderSakIT {
    ...
    fun `skal generere meldeperioder for to innvilgede søknader med hull mellom, uten meldeperioder i hullet`() {
        ...
        withTestApplicationContext(clock = clock) { tac ->
            ...
            // Den andre innvilgelsen starter søndag 1. juni 2025, slik at den første meldeperioden (19. mai - 1. juni) kun har rett i helg.
            // Saken må derfor kunne sende inn helg for at meldeperiodene skal være gyldige.
