...
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.behandling.Behandlingsstatus.AVBRUTT
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.behandling.Behandlingsstatus.KLAR_TIL_BEHANDLING
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.behandling.Behandlingsstatus.KLAR_TIL_BESLUTNING
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.behandling.Behandlingsstatus.UNDER_BEHANDLING
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.behandling.Behandlingsstatus.UNDER_BESLUTNING
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.behandling.Behandlingsstatus.VEDTATT
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.behandling.Behandlingstype.FØRSTEGANGSBEHANDLING
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.behandling.Behandlingstype.REVURDERING
...
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.vilkår.Utfallsperiode.IKKE_RETT_TIL_TILTAKSPENGER
import no.nav.tiltakspenger.vedtak.saksbehandling.domene.vilkår.Utfallsperiode.RETT_TIL_TILTAKSPENGER
