...
import no.nav.tiltakspenger.vedtak.routes.meldekort.dto.MeldekortBehandlingStatusDTO
...
fun BrukersMeldekort.toOversiktDTO(): MeldekortoversiktDTO {
    return MeldekortoversiktDTO(
        meldekortId = id.toString(),
        periode = periode.toDTO(),
        status = MeldekortBehandlingStatusDTO.UTFYLT,
        saksbehandler = null,
        beslutter = null,
    )
}
...
fun Meldeperiode.toOversiktDTO(): MeldekortoversiktDTO {
    return MeldekortoversiktDTO(
        ...
        status = MeldekortBehandlingStatusDTO.KLAR_TIL_UTFYLLING,
        saksbehandler = null,
        beslutter = null,
    )
}
